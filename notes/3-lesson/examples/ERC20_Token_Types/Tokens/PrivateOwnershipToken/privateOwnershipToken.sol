...
contract PrivateOwnershipToken is StandardToken, Ownable {
  ...
  function ownTokens(address _address, bool _value) public onlyOwner  {
     ...
     **/
    function transferFrom(address _from, address _to, uint256 _value) public override tokensOwnable returns (bool) {
        require(canOwnTokens[_to] == true);
     ...
     * @dev approve spender 
     **/
    function approve(address _spender, uint256 _value) public override tokensOwnable returns (bool) {
     ...
     **/
    function increaseApproval(address _spender, uint _addedValue) public override tokensOwnable returns (bool success) {
     ...
     **/
    function decreaseApproval(address _spender, uint _subtractedValue) public override tokensOwnable returns (bool success) {
